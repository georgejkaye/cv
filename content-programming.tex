...
\begin{tikzpicture}[
    ...
    \experience{Developer}{Acturis Ltd}{%
        ...
        Currently working as part of an agile backend team on the dual entity
        quoting engine used by the the Acturis application,
        primarily using C\# and Oracle SQL for development combined with
        Bamboo for continuous integration, automated testing, and deployment.
        Additionally using TypeScript/React for internal
        tools aimed at developers and business analysts, along with PowerShell
        and Python scripts for automation of complex tasks such as mutation
        testing, gathering code quality statistics for company KPIs, and
        analysing the team's timelogging data.
    }{title 1}
    ...
    \experience{Research Intern}{Huawei R\&D, Edinburgh}{%
        ...
        Worked as part of the Programming Languages Lab in designing and
        implementing a hardware description language in Huawei's new open-source
        programming language Cangjie, and also developed compiler optimisations
        for the new language in \textsc{C++}.
    }{item 2}
    \node[
    ...
    \education{%
        ...
        passed with minor corrections in September 2024.
